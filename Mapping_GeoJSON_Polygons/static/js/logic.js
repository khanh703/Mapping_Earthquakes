...
// Add GeoJSON data.
let torontoHoods = "https://raw.githubusercontent.com/khanh703/Mapping_Earthquakes/main/torontoNeighborhoods.json";
...
d3.json(torontoHoods).then(function(data) {
  ...
  L.geoJSON(data, {
   ...
   onEachFeature: function(feature, layer){
    let popup = L.popup().setContent("<h2>"+feature.properties.AREA_NAME +", " +feature.properties.AREA_S_CD+ "</h2>");
